...
public class Driver {
	...
	if (args.length < 3) {
        ...
        String outputPath = "output_tayllan_hadoop";
	...
	if (args.length == 4) {
        ...
        //System.out.println("Total Execution Time in Milliseconds: " + totalExecutionTimeInMilliseconds + "ms");
        double elapsedTimeInSec = (System.nanoTime() - start) * 1.0e-9;
        System.out.println("<" + elapsedTimeInSec + "s> " + dateFormat.format(new Date()));
    }
    
    /***
     * Reads the initial Adjacency List and sets the initial PageRank values,
     * i.e. (1 / amountOfOuterEdges).
     * 
     * @param inputPath
     * @param outputPath
     ...
     */
    private static void startInitialJob(String inputPath, String outputPath, int amountOfVertices)
            throws IOException, InterruptedException, ClassNotFoundException {
    ...
    /***
     * Reads the Adjacency List and the PageRank value of each Vertex and
     * updates it.
     * 
     * @param inputPath
     * @param outputPath
     ...
     * @throws ClassNotFoundException 
     */
    private static void startPageRankJob(String inputPath, String outputPath, int amountOfVertices)
            throws IOException, InterruptedException, ClassNotFoundException {
        Configuration conf = new Configuration();
