...
public class Driver {
    ...
    private static void startInitialJob(String inputPath, String outputPath, String sourceNode)
    ...
    private static void startSSSPJob(String inputPath, String outputPath)
            throws IOException, InterruptedException, ClassNotFoundException {
        Configuration conf = new Configuration();
